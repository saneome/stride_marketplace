# Marketplace - Доска объявлений б/у товаров

Интернет-магазин для продажи техники, спорт-инвентаря (велосипеды, самокаты, ватрушки и т.д.) с разделом б/у товаров, где пользователи могут подавать объявления после регистрации, а модераторы проверяют их перед публикацией.
...
│   │   ├── security/       # JWT, пароли, 2FA
│   │   ├── middleware/     # Middleware (rate limit, audit)
│   │   └── utils/          # Утилиты
│   ├── alembic/            # Миграции
│   ├── tests/              # Тесты
